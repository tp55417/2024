  ...
  <main id="sponsorship" class="page-container">
    ...
    <section class="markdown">
          ...
          <thead>
            <tr>
              ...
              >
                ...
                <p v-html="markdown(t(`sponsorship.level.list.${key}.name`))"></p>
                {{ t(`sponsorship.level.list.${key}.subtitle`) }}
              </th>
            </tr>
          </thead>
          <tbody>
      ...
      <ul class="level-list">
        ...
        >
          <img :src="getImageFromLevel(key)" :alt="t(`sponsorship.level.list.${key}.name`)" >
          <h4 v-html="markdown(t(`sponsorship.level.list.${key}.name`))" />
          ...
          <thead>
            <tr>
              ...
              >
                ...
                <h4 v-html="markdown(t(`sponsorship.level.list.${level}.name`))"></h4>
              </th>
            </tr>
          </thead>
          <tbody>
